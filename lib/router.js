...
// 秀人网
router.get('/xiuren/girls/:girl?', lazyloadRouteHandler('./routes/xiuren/girl'));
router.get('/xiuren/categories/:category?', lazyloadRouteHandler('./routes/xiuren/category'));
router.get('/xiuren/tags/:tag?', lazyloadRouteHandler('./routes/xiuren/tag'));
router.get('/xiuren/search/:keyword?', lazyloadRouteHandler('./routes/xiuren/search'));
